...
export default function App() {
  ...
  return <div className="app">
    <header><div><p className="eyebrow">A PROJECT BY MD. MAHFUZUR RAMAN</p><h1>IoT-Based Computer Vision Robotic Arm</h1><p className="subtitle">Controlled by hand gestures · Powered by MediaPipe, MQTT and ESP robotics</p></div><div className="header-actions"><div className="gesture"><small>DETECTED</small><strong>{hasHand?`${fingers} FINGER${fingers===1?'':'S'}`:'NO HAND'}</strong></div><button className="icon-button" onClick={()=>setSettings(v=>!v)}>⚙ Settings</button></div></header>
